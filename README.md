...
1. **Trybe Futebol Clube** - Projeto de uma API REST para um campeonato de futebol. <br>
...
3. **API para Blogs** - Projeto de uma API REST para Blogs. <br>
...
4. **Store Manager** - Projeto de uma API REST para gerenciar as vendas e produtos de uma loja.<br>
...
5. **Talker Manager** - Projeto de uma API REST para gerenciar palestrantes de eventos.<br>
 ...
 6. **POO - trybers and dragons** - Projeto de modelagens de personagens e batalhas com POO.<br>
...
7. **Mysql One For All** - Projeto de modelzagem e criação de um banco de dados mysql.<br>
...
8. **MySQL All For one** - Desafios de seleção, filtragem e manipulação de dados.:<br>
   https://github.com/tamireshc/backend/tree/master/mySQL-all-for-one<br>
   
9. **Docker todo list** - Desafios de comandos em docker para a criação, manipulação de containers e composes.:
